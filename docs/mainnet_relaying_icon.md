...
1. Get the version of latest binary of the relay from the github assets from this [repo](https://github.com/icon-project/ibc-relay)
2. Then, download the relay binary from the assets of this release on your machine.
```sh
export CURR_VERSION=1.1.1
wget https://github.com/icon-project/ibc-relay/releases/download/v${CURR_VERSION}/ibc-relay_${CURR_VERSION}_linux_amd64.tar.gz
