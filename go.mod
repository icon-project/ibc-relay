...
require (
	...
	github.com/cosmos/ibc-go/modules/light-clients/08-wasm v0.0.0-20240215142521-055a3e39c3da
	...
	github.com/icon-project/ibc-integration v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/icon-project/ibc-integration => github.com/icon-project/ibc-integration v1.1.1-0.20240215093716-59d9533340d2
)
