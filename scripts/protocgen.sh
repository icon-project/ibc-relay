...
rm -r github.com/icon-project/relayer/v2/relayer/chains/penumbra/client
rm -r github.com/icon-project/relayer/v2/relayer/chains/penumbra/narsil
cp -r github.com/icon-project/relayer/v2/* ./
rm -rf github.com
